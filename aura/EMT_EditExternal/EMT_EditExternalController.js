({
    ...
    doInit : function(component, event, helper) {
       ...
       component.set('v.columns', [
        ...
        helper.fetchExistingData(component);
    ...
    handleHandsOnTutorial : function(component)
    {
        ...
        console.log("number "+component.get("v.eventObject.CT_Number_of_hands_on_tutorials__c"))
    ...
    handleCloneEventClick : function(component, event, helper) {
        ...
        var eventId = component.get("v.value.Id");
        ...
        //console.log('Before send =='+ component.get("v.eventObject.Event_type__c") + '==='+component.get("v.eventObject.CT_External_event_subtype__c"));
        childComponent.getCallEventTypeMethod(component.get("v.eventObject.Event_type__c"),component.get("v.eventObject.CT_External_event_subtype__c"),'');
        //helper.getClonedBusinessData(component,eventId);
    },
    ...
    handleChangeEventSearchBoxN:function(component, event, helper) {
        ...
        component.set("v.eventObject.CT_Reaccuring_event__c",false);
  ...
  /*  handleLeadCheckBox:function(component) {
        console.log("the lead value is "+ component.get("v.leadValue"));
        if(component.get("v.leadValue")=='true') {
    ...
    saveRecord : function(component, event, helper) {
        ...
        if(showEventTypeAndSize == true){
            console.log("Event type and size succesfully called!"+showEventTypeAndSize);
             if(component.get("v.eventObject.external_event_subtypes__c")!='Exhibition/tradeshow')
             {
                 component.set("v.eventObject.CT_relevant_attendees_to_booth__c",'');
                 component.set("v.eventObject.CT_Size_of_booth_m2__c",'');
                 component.set("v.eventObject.CT_Booth_type__c",'');
             }
            if(component.get("v.eventObject.Event_type__c")== '--- None ---'){
                component.set("v.eventObject.Event_type__c",'');
            }
        ...
        if(showEventFocus == true){
          //  console.log("Event Focus called!");
       ...
       // console.log("on save "+component.get("v.eventObject.CT_Step__c"));
    },
    nextTab : function(component, event, helper) {
       ...
       component.set("v.showGuidance",false);
        ...
        if(component.get("v.eventRecordTypeCheckExternal") && (showEventTypeAndSize == true)){
            component.set("v.showBasicData", false);
    ...
    prevTab : function(component, event, helper) {
        ...
        //for progress indicator
        //console.log("on back "+component.get("v.selectedStep"));
        var getselectedStep = component.get("v.selectedStep");
    ...
    handleDualPicklistChange: function (component, event) {
       ...
       // console.log("inside dual selexctedcmpopt "+component.get("v.selectedCampaignOptionList"));
        component.set("v.eventObject.Campaign_Focus_Area__c", selectedValues);
      //  console.log("inside dual cmpfocArea "+component.get("v.eventObject.Campaign_Focus_Area__c"));
    },
    ...
    handleShowModal: function(component, evt, helper) {
        var modalBody;
        $A.createComponent("c:EMT_DependentDualPicklist", {"businessComponentEvent": component.getReference("c.handleBusinessDataEvent"),"listBusinessData":component.get("v.listBusinessData"),"arrayBusinessData":component.get("v.arrayBusinessData"),"listBusinessData":component.get("v.data")},
                           function(content, status) {
                               if (status === "SUCCESS") {
                                   component.set('v.body', content);
                                   modalBody = content;
   ...
   handleLeadOption : function(component,event)
    {
        ...
        if(changeValue == 'false'){
            component.set("v.eventObject.CT_Expected_number_of_leads__c",null);    
           	component.set("v.leadValue",changeValue);  
           // component.set("v.eventObject.Capturing_leads_at_the_event__c",false);
        }
    },
